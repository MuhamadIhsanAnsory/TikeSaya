    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with(TicketDetailAct.this).load(dataSnapshot.child("url_thumbnail").getValue().toString())
                        .fit().centerCrop().into(header_ticket_detail);
            }
        ...
        btn_buy_ticket.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent gotochechkout = new Intent(TicketDetailAct.this,TicketCheckoutAct.class);
                gotochechkout.putExtra("jenis_tiket", jenis_tiket_baru);
                startActivity(gotochechkout);
            }
        });
